...
An AI-native autonomous development team blueprint. Copy this `.claude/` folder and `CLAUDE.md` to any project for autonomous software development.
...
1. Copy `.claude/` folder and `CLAUDE.md` to your project
2. Run `/build [describe what you want]`
3. Wait for UAT notification
4. Review and `/approve` or `/feedback [changes needed]`

---

**Note**: This is a blueprint. Customize agents, skills, and workflows for your specific needs.
